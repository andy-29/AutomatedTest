...
@ddt
class Hospital_Pay_Create(unittest.TestCase):
    '''
    ...
    @data(*(get_values(func, "test_hospital_pay_create")))
    def test_hospital_pay_create(self,value):
        self._testMethodDoc = "--"
        '''

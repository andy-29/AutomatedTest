...
@ddt
class Search_Result_Diary(unittest.TestCase):
    '''
    搜索查看更多日记
    '''
    ...
    @data(*(get_values(func, "test_search_result_diary")))
    def test_search_result_diary(self,value):
        '''
        搜索查看更多日记
        '''

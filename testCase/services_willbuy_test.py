...
@ddt
class Services_Willbuy(unittest.TestCase):
    '''
    ...
    def test_services_willbuy(self,value):
        ...
        for item in r.get('data').get('services'):
            ...
            self.assertIsInstance(item.get('seckill_status'), (int,str))
            ...
            self.assertIsInstance(item.get('ordering'), str)
            ...
            self.assertIsInstance(item.get('seckill_price'), (int,str))
        ...
        self.assertIsInstance(r.get('data').get('offset'), int)

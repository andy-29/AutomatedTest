...
@ddt
class Search_Result_Question(unittest.TestCase):
    '''
    搜索查看更多问答
    '''
    ...
    @data(*(get_values(func, "test_search_result_question")))
    def test_search_result_question(self,value):
        '''
        搜索查看更多问答
        '''

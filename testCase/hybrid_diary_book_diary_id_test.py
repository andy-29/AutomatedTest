...
@ddt
class Hybrid_Diary_Book_Diary_Id(unittest.TestCase):
    '''
    ...
    @data(*(get_values(func, "test_hybrid_diary_book_diary_id")))
    def test_hybrid_diary_book_diary_id(self,value):
        '''
...
if __name__ == "__main__":
    Hybrid_Diary_Book_Diary_Id.run()
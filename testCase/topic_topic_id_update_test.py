...
@ddt
class Topic_Topic_Id_Update(unittest.TestCase):
    '''
    ...
    @data(*(get_values(func, "test_topic_topic_id_update")))
    def test_topic_topic_id_update(self,value):
        self._testMethodDoc = "--"
        '''

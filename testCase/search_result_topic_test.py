...
@ddt
class Search_Result_Topic(unittest.TestCase):
    '''
    搜索查看更多帖子
    '''
    ...
    @data(*(get_values(func, "test_search_result_topic")))
    def test_search_result_topic(self,value):
        self._testMethodDoc = "--"
        '''
        搜索查看更多帖子
        '''

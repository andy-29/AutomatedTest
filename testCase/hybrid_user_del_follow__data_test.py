...
@ddt
class Hybrid_User_Del_Follow__Data(unittest.TestCase):
    '''
    ...
    @data(*(get_values(func, "test_hybrid_user_del_follow__data")))
    def test_hybrid_user_del_follow__data(self,value):
        self._testMethodDoc = "--"
        '''
...
if __name__ == "__main__":
    Hybrid_User_Del_Follow__Data.run()
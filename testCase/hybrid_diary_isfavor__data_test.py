...
@ddt
class Hybrid_Diary_Isfavor__Data(unittest.TestCase):
    '''
    ...
    @data(*(get_values(func, "test_hybrid_diary_isfavor__data")))
    def test_hybrid_diary_isfavor__data(self,value):
        '''
...
if __name__ == "__main__":
    Hybrid_Diary_Isfavor__Data.run()
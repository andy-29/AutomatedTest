...
@ddt
class Hybrid_Wiki_Compare(unittest.TestCase):
    '''
    ...
    @data(*(get_values(func, "test_hybrid_wiki_compare")))
    def test_hybrid_wiki_compare(self,value):
        '''

...
@ddt
class Hybrid_Diary_My__Data(unittest.TestCase):
    '''
    ...
    @data(*(get_values(func, "test_hybrid_diary_my__data")))
    def test_hybrid_diary_my__data(self,value):
        self._testMethodDoc = "--"
        '''

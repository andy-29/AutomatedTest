...
@ddt
class Hybrid_Organization_Id(unittest.TestCase):
    '''
    ...
    @data(*(get_values(func, "test_hybrid_organization_id")))
    def test_hybrid_organization_id(self,value):
        '''
